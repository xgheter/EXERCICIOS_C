...
#include <conio.h>
int main(){
	int v[5]={45,-89,32,-12,33},v1[6]={41,72,39,4,35},v2[6]={0,0,0,0,0},s,select,i,r,var,n1,j,t,option;
	float med, n;
	do{
			printf("---------Menu----------\n");
			printf("1 == Ex1\n");
	...
	printf("O maior valor do vetor eh %d", x);
			...
			case 27:
				sleep(2);
				printf("Criador do menu: Caio Bernardo\n");
				printf("Dev's: Caio Bernardo e Jesus\n");
				printf("ex. 22:14\n");
				sleep(2);
				system("pause");
				system("cls");
